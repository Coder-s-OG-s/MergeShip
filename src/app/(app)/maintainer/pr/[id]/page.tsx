  ...
  return (
    <div className="min-h-screen bg-zinc-950 px-6 py-12 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        {/* Header Section */}
        <header className="mb-8 rounded-3xl border border-zinc-800 bg-zinc-900/40 p-6 backdrop-blur-md">
          <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {pr.mentorVerified ? (
                  <span className="rounded-full border border-emerald-500/30 bg-emerald-950/80 px-3 py-1 text-xs font-medium text-emerald-300">
                    ✓ Mentor verified {pr.mentorReviewerHandle && `by @${pr.mentorReviewerHandle}`}
                  </span>
                ) : (
            ...
            <div className="flex items-center gap-2">
              ...
              {pr.state === 'open' && <ClosePrButton prId={pr.id} />}
            </div>
          </div>
            ...
            <div className="flex items-center gap-6">
              ...
              {pr.authorXp !== null && (
                <div className="text-center md:text-left">
                  ...
                  <p className="text-base font-bold text-white">{pr.authorXp.toLocaleString()}</p>
                </div>
              )}
            ...
            <div className="relative">
              ...
              <div className="space-y-6">
                {timelineEvents.map((event) => {
                  const isApproved = event.type === 'review' && event.details.state === 'approved';
                      ...
                      >
                        ...
                        {event.type === 'review' && (
                          <>
                            ...
                            {!isApproved && !isChangesRequested && <FileText className="h-4 w-4" />}
                          </>
                        )}
                      </div>
