...
export function IssueCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "rounded-2xl p-5 border border-white/5 transition-colors cursor-pointer bg-[#1E1826]/80 flex flex-col min-h-[220px]",
        className
      )}
    >
      ...
      <div className="flex flex-col gap-2 mb-4 flex-grow">
        <h4 className="font-bold text-white text-base leading-snug group-hover:text-[#D8B4FE] transition-colors">{title}</h4>
        {highlight && (
