  ...
  return (
    <div
      ...
      className={[
        ...
        // Variant colours
        isLevelUp
          ? ['border-emerald-500/50 bg-[#081410]', 'shadow-[0_0_24px_rgba(16,185,129,0.15)]'].join(
              ' ',
            )
          : ['border-zinc-700/70 bg-[#13161d]', 'shadow-[0_4px_24px_rgba(0,0,0,0.5)]'].join(' '),
      ].join(' ')}
    >
      {/* Icon + message */}
      <div className="flex items-start gap-3">
        ...
        <span
          className={[
            'text-[11px] uppercase leading-relaxed tracking-widest',
            isLevelUp ? 'font-bold text-emerald-300' : 'font-medium text-zinc-200',
          ].join(' ')}
        >
          {toast.message}
        </span>
